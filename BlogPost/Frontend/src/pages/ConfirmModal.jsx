...
export default function ConfirmModal({
  ...
  // 🟢 ADD THIS LINE: If not open, don't render anything at all
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl animate-fadeIn">
        <h2 className="text-xl font-semibold text-[#4A4947] mb-2">{title}</h2>
        <p className="text-[#4A4947] opacity-80 mb-6">{message}</p>
